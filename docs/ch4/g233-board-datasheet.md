...
+---------+--------+--------+----------+-------------------+-------+
     6                           6                          0x73
+---------+--------+--------+----------+-------------------+-------+
| 000110  |  rs2   |  rs1   |    110   |         rd        |1110011| dma
+---------+--------+--------+----------+-------------------+-------+
```
...
+---------+--------+--------+----------+-------------------+-------+
     6                           6                          0x77
+---------+--------+--------+----------+-------------------+-------+
| 000110  |  rs2   |  rs1   |    110   |         rd        |1110111| sort
+---------+--------+--------+----------+-------------------+-------+
```
...
将一个格式为 8B 的数组中的每个元素的低 4B 抽出来，两两打包进一个 8B，然后存放到一个新的数组当中。
...
+---------+--------+--------+----------+-------------------+-------+
     6                           6                          0x7b
+---------+--------+--------+----------+-------------------+-------+
| 000110  |  rs2   |  rs1   |    110   |         rd        |1111011| pack
+---------+--------+--------+----------+-------------------+-------+
```
...
将一个格式为 8B 的数组中的每个元素，按照 4B 大小拆分进两个 8B 元素中，然后放到一个新的数组当中。
...
+---------+--------+--------+----------+-------------------+-------+
     6                           6                          0x7f
+---------+--------+--------+----------+-------------------+-------+
| 000110  |  rs2   |  rs1   |    110   |         rd        |1111111| unpack
+---------+--------+--------+----------+-------------------+-------+
```
